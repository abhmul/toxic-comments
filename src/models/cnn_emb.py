...
class CNNEmb(AEmbeddingModel):
    ...
    def __init__(self, embeddings_path, trainable=False, vocab_size=None, num_features=None, kernel_size=3,
                 ...
                 k=5, input_dropout=0.66, conv_dropout=0.2, fc_size=0, fc_dropout=0.5, batchnorm=True):
        ...
        self.embedddings_dropout = nn.Dropout(input_dropout)
    ...
    def forward(self, x):
        x = [self.embedddings_dropout(sample.unsqueeze(0)).squeeze(0) for sample in x]
